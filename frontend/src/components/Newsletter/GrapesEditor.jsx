...
const GrapesEditor = () => {
  ...
  useEffect(() => {
    ...
    const editor = grapesjs.init({
      ...
      storageManager: {
        type: 'remote',
        stepsBeforeSave: 1,
        urlStore: 'https://modelo-de-negocios-backend-180g.onrender.com/save/newsletter',
        params: {},
        headers: {},
      },
  ...
  const handleSubmit = async (content) => {
    ...
    try {
      const response = await fetch('https://modelo-de-negocios-backend-180g.onrender.com/save/newsletter', {
        method: 'POST',
        headers: {
      ...
      navigate(`/newslettermeta/${responseData._id}`);
    } catch (error) {
